...
#EDIT THE FOLLOWING:
$toAddress = "a.wado@live.com";  //place your/your client's email address here
$toName = "Essam Muhammad"; //place your client's name here
$website = "FP Client Form";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Thanks for your interest. We will get back to you within 2 business days</h2>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Leave us a message" tabindex="60"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
